...
// Shared page open menu: [preview AppWindow] + [open-full ↗]. Used by pageLink NodeViews and by
// page frames whose content is still regular TipTap blocks (linkedPageId, no pageLink yet).
...
export const PageOpenMenu = forwardRef<HTMLSpanElement, PageOpenMenuProps>(
  function PageOpenMenu({ pageId, className, style, forceVisible }, ref) {
    const actions = usePageLinkActions() // Host frame preview / open / prefetch
