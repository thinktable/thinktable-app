...
- Minimap + Linear/Free nav toggle sit on the **bottom-left** of the page; the **chat sidebar toggle logo** (with topper) stays on the **bottom-right** of the page column; the **flashcard study menu** (`left-vertical-menu.tsx`) + its open/close pill sit **centered at the bottom** of the page.
